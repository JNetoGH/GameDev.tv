...
public sealed class RocketController : MonoBehaviour {
    ...
    [SerializeField] public Vector3 MoveDirection { get; } = Vector3.up;
    [SerializeField] public Vector3 gravity = new Vector3(0, -9.81f, 0); // default gravity
    ...
    // States: they are just useful to get a picture of the rocket's current state
    ...
    // manages all the collisions that are not the landing pad, there is a special script for managing this case
    private void OnCollisionEnter(Collision collision) {
        // Simply ignores the Landing Pad or if the player has won and is loading the next lexel
